...
if (left > right){    // в конце концов правый край и левый сойдутся, и тогда можно заканчивать, тк массива больше не осталось
  return -1   
}
if(arr[midInd]===x){ // удачный сценарий, нашли
  console.log(midInd)
  return midInd
}
if (x > arr[midInd]){ //если х больше, то он в правой стороне, двигаем интересующую нас часть массива вправо
