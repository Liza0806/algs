...
function bubbleSort(array) {
    ...
    for (let i = 0; i < array.length - 1; i++) {
        debugger
        for (let j = 0; j < array.length - i - 1; j++) { //// в этом цикле мы проходимся по массиву и двигаем 1 цифру вперед, то есть на 1й ит
            ...
            if (array[j] > array[j + 1]) {              //// соотв-но это условие: (let j = 0; j < array.length - i - 1; j++) значит, что на сл цикле 
